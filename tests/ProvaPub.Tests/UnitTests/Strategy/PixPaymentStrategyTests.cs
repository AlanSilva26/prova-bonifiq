...
{
    private readonly PixPaymentStrategy _paymentStrategy;
    private readonly Mock<IOrderRepository> _orderRepositoryMock;

    public PixPaymentStrategyTests()
    {
        _orderRepositoryMock = new Mock<IOrderRepository>();
        _paymentStrategy = new PixPaymentStrategy(_orderRepositoryMock.Object);
    }

    [Fact(DisplayName = "Deve criar um pedido corretamente ao processar pagamento via Pix")]
